...
public enum SystemsApiEnum {
    ...
    UPDATE_DATA_STORE("更新数据存储",
            ...
            HttpMethod.PUT, ParamPosition.PATH, ParamPosition.BODY,
            String.class),

    DELETE_DATA_STORE("删除数据存储",
            "/v1/datastore",
            HttpMethod.DELETE, ParamPosition.BODY, ParamPosition.NONE,
            HorizontalScalabilityEntity.class),

    GET_DATA_STORES("获取数据存储列表",
            "/v1/datastores",
            HttpMethod.GET, ParamPosition.QUERY, ParamPosition.NONE,
            null),

    ADD_DATA_STORE("添加数据存储",
            "/v1/datastoretostorage",
            HttpMethod.POST, ParamPosition.BODY, ParamPosition.NONE,
            HorizontalScalabilityEntity.class),
    ...
    GET_SERVERS("获取指定用户下的服务器信息",
            ...
            HttpMethod.GET, ParamPosition.PATH, ParamPosition.NONE,
            null),
    ...
    MODIFY_HISTORIAN_SERVER("修复服务器",
            ...
            HttpMethod.PUT, ParamPosition.BODY, ParamPosition.NONE,
            HistorianServerEntity.class),

    GET_SERVER_TYPE("获取服务器类型信息",
            "/v1/historianserver/type",
            HttpMethod.GET, ParamPosition.NONE, ParamPosition.NONE,
            null),
    ...
    SystemsApiEnum(String desc, String path, HttpMethod method, ParamPosition primaryParamPosition, ParamPosition secondaryParamPosition, Class<?> entityType) {
        this.desc = desc;
        this.path = path;
        this.method = method;
